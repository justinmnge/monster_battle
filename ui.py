...
class UI:
    ...
    def input(self):
        ...
        if self.state == 'general':
            ...
            self.attack_index['row'] = (self.attack_index['row'] + int(keys[pygame.K_DOWN]) - int(keys[pygame.K_UP])) % 2
            self.attack_index['col'] = (self.attack_index['col'] + int(keys[pygame.K_RIGHT]) - int(keys[pygame.K_LEFT])) % 2
            if keys[pygame.K_SPACE]:
